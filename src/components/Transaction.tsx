...
const Transactions  = () : JSX.Element => {
    ...
    useEffect(() => {
        //get payments for selected country
        if (selectedCountry !== ""){
    ...
    uniqueCountries.map(activeCountry => <option key={activeCountry} value={activeCountry}> {activeCountry} </option>);
